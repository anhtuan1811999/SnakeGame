...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    //random point position cordinateson the surfaceView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //check if previous moving is not bottom. Snake can't move,
    ...
    public void surfaceCreated(@NonNull SurfaceHolder surfaceHolder) {
        ...
        //when surface is created then get surface from it and assign to surfaceHolder
    ...
    private void init(){
        ...
        int startingPositionX = (pointSize)*defaultTalePoints;
        ...
        for (int i = 0; i < defaultTalePoints; i++){
            ...
            //increase value for next point as snake's tale
        ...
        //start moving / start game;
        moveSnake();
    }

    private void addPoint(){

        //getting surfaceView width and height to add point on the surface to be eaten by snake;
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if (headPositionX == positionX && positionY == headPositionY ){
                    ...
                    //grown snake after eaten point
                    growSnake();

                    //add other random point to screen
                    addPoint();
                }
                ...
                //check if game over. Weather snake touch edges or itself
                if (checkGameOver(headPositionX, headPositionY)){
                    ...
                    //timer run in background so we need to show dialog in main thread
                    ...
                    //other point is following snake's head. position 0 is head of snake
    ...
    private boolean checkGameOver(int headPositionX,int headPositionY){
        ...
        //check if snake's head touch edges
        if (snakePointsList.get(0).getPositionX() < 0 ||
            ...
            //check if snake's head touchs snake itseft
    ...
    private Paint createPointColor(){
        ...
        // check if color is not defined before
        if (pointColor == null){
